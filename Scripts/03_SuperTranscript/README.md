...
To run SuperTranscripts, you can either modify the provided [03_SuperTranscripts.sh](https://github.com/mjbieren/Zygnematophyceae_Phylogenomics/blob/main/Scripts/03_SuperTranscript/03_SuperTranscript.sh) script or execute the following command directly:
